...
#define STRING_CONFIG_H_AUTHOR "(Rse_ua, CoreXY)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CoreXY by grblmm"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 12.5933f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 1.4738f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0700f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0941f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -21, -1.9 }
